...
INSERT INTO `authority` (`name`, `code`) VALUES ('Test Authority', 'test');
INSERT INTO `role` (`name`, `description`) VALUES ('Admin', 'Admin');

INSERT INTO `user` (`name`, `username`, `password`, `status`, `failed_login_attempt_count`)
 VALUES ('Admin', 'admin', '$2a$10$5IZ9f4x6xS3UnRix.57Y8.dNieo4oP4w0ZZr5S94ZUp.Tb70QwKtS', 'A', 0);

INSERT INTO `user_role` (role_id, user_id) VALUES ((SELECT id FROM `role` WHERE name = 'Admin'),
(SELECT id FROM `user` WHERE username = 'admin'));

INSERT INTO role_authority (role_id, authority_id)
VALUES ((SELECT id FROM role WHERE name = 'Admin'), (SELECT id FROM authority WHERE code = 'test'));
